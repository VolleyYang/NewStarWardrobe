...
public class ChinaAdapterContent extends RecyclerView.Adapter {

    private Context mContext;
    private ChinaDataContent data;
    ...
    public ChinaAdapterContent(Context context) {
        mContext = context;
    }

    public void setData(ChinaDataContent data) {
        this.data = data;
