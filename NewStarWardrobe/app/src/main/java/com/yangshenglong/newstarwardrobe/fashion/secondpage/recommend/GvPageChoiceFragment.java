...
public class GvPageChoiceFragment extends BaseFragment {
    ...
    public int setLayout() {
        return R.layout.fragment_gv_page_choice;
    }

    @Override
    public void initView(View view) {
        lRecyclerView = (LRecyclerView) view.findViewById(R.id.gv_page_rv);
    }
    ...
    public void initData() {
        ...
        id = GvPageAty.sendId();
        //拼接  接口
        url = "http://api-v2.mall.hichao.com/forum/tag/get-new?flag=&tag_id="+ id + "&recommend=1&ga=%2Fforum%2Ftag%2Fget-new";
        //初始化适配器
