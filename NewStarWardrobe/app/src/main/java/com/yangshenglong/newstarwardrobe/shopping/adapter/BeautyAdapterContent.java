...
public class BeautyAdapterContent extends RecyclerView.Adapter {

    private Context mContext;
    private BeautyDataContent data;

    private MyClick mClick;//声明接口对象

    // 定义不同行布局
    private static final int TYPE_ADVERTISE = 0;
    private static final int TYPE_NORMAL = 1;

    public BeautyAdapterContent(Context context) {
        mContext = context;
    }

    public void setData(BeautyDataContent data) {
        this.data = data;
